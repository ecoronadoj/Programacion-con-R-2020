...
#### Objetivo 
- Manipular y reconocer datos de diversas naturalezas
- Asigar valores a variables
- Sentar las bases para rear vectores
...
#### Desarollo
A continuación encontraras líneas de código las cuales servirán como guía, ejecutalas una por una, para hacer esta ejecución siempre se hará con **Ctrl + Enter**
